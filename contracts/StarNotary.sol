...
contract StarNotary is ERC721Full {
    ...
    constructor() public ERC721Full("Star Notary", "STARNOT") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        _transferFrom(tokenOneOwner, tokenTwoOwner, _tokenId1);
        _transferFrom(tokenTwoOwner, tokenOneOwner, _tokenId2);
    }
